...
function diff3Lines(base, other) {
    const ops = [];
    let bi = 0;
    let oi = 0;
...
// Three-way merge
function merge3(base, ours, theirs, oursLabel = 'HEAD', theirsLabel = 'incoming') {
...
function mergeFiles(baseContent, ourContent, theirContent, oursLabel = 'HEAD', theirsLabel = 'incoming') {
...
function findMergeBase(commit1, commit2, repoRoot) {
