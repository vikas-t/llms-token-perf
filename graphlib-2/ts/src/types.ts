...
export interface Graph {
  ...
  weighted: boolean;
  nodes: Set<string>;
  adjacency: Map<string, Map<string, number>>; // from -> to -> weight
  inEdges: Map<string, Map<string, number>>; // for directed graphs: to -> from -> weight
}
...
export interface GetGraphInfoResult {
  id: string;
  directed: boolean;
  weighted: boolean;
  node_count: number;
